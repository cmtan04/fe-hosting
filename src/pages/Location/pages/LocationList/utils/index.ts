...
export const buildMergedFilter = (
  ...
  if (baseFilter) Object.assign(mergedFilter, baseFilter);
  if (queryFilter) Object.assign(mergedFilter, queryFilter);
  if (routeFilter) Object.assign(mergedFilter, routeFilter);
